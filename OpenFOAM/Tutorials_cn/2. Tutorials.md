...
重力加速度在整个域中是均匀的，并在名为*g的文件中指定*在*常量*目录中。与普通的域文件不同，*例如* *U*和*p*，*g*是一个*uniformDimensionedVectorField*，因此只包含一组维度和一个代表本教程的值：![(0,9.81,0) 毫秒- 2](https://cdn.cfd.direct/docs/user-guide-v9/img/user205x.png)
